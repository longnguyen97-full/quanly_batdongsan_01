...
<div align="center" width="100%">
	...
	<h2 style="color: #DD940B">GIÁ TRỊ CỐT LÕI </h2>
	<br/>
	<table border="0" width="100%" cellpadding="0" cellspacing="0">
		<tr>
			<td width="18%" align="center">
				<div class="dv-img--1"><img src="Hinh/gia-tri-1.png"/></div><br/>
				<h3>Cam Kết</h3>
			</td>
			<td width="18%" align="center">
				<div class="dv-img--2"><img src="Hinh/gia-tri-2.png"/></div><br/>
				<h3>Tôn Trọng</h3>
			</td>
			<td width="18%" align="center">
				<div class="dv-img--3"><img src="Hinh/gia-tri-3.png"/></div><br/>
				<h3>Hợp Tác</h3>
			</td>
			<td width="18%" align="center">
				<div class="dv-img--4"><img src="Hinh/gia-tri-4.png"/></div><br/>
				<h3>Sáng Tạo</h3>
				
			</td>
			<td width="18%" align="center">
				<div class="dv-img--5"><img src="Hinh/gia-tri-5.png"/></div><br/>
				<h3>Học Tập</h3>
			</td>
		</tr>
		<tr>
